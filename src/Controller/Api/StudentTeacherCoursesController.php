...
class StudentTeacherCoursesController extends AppController
{
    ...
    public function index()
    {
        ...
        $studentTeacherCourses = $this->paginate($this->StudentTeacherCourses)->toArray();
        return $this->response
            ->withType('application/json')
            ->withStatus(200)
            ->withStringBody(json_encode($studentTeacherCourses,1));
    ...
    public function view($id = null)
    {
        ...
        return $this->response
            ->withType('application/json')
            ->withStatus(200)
            ->withStringBody(json_encode($studentTeacherCourse,1));
    ...
    public function add()
    {
        ...
        return $this->response
            ...
            ->withStringBody(json_encode([
                'studentTeacherCourses' => $teacherCourses,
                'students' => $students,
